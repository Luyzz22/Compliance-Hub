...
def test_missing_api_key_returns_401(client_and_repository: tuple[TestClient, AISystemRepository]) -> None:
...
def test_missing_tenant_id_returns_400(client_and_repository: tuple[TestClient, AISystemRepository]) -> None:
    client, _ = client_and_repository
...
def test_invalid_api_key_returns_401(client_and_repository: tuple[TestClient, AISystemRepository]) -> None:
    client, _ = client_and_repository
