...
class Permission(StrEnum):
    ...
    VIEW_IMPACT_ASSESSMENTS = "view_impact_assessments"
    MANAGE_IMPACT_ASSESSMENTS = "manage_impact_assessments"
...
_CONTRIBUTOR_PERMS = _VIEWER_PERMS | frozenset(
    {
        ...
        Permission.VIEW_IMPACT_ASSESSMENTS,
    }
)
...
_COMPLIANCE_OFFICER_PERMS = _EDITOR_PERMS | frozenset(
    {
        ...
        Permission.MANAGE_IMPACT_ASSESSMENTS,
    }
)
